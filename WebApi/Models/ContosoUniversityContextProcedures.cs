...
namespace WebApi.Models
{
    ...
    public partial class ContosoUniversityContextProcedures : IContosoUniversityContextProcedures
    {
        ...
        public virtual async Task<List<GetMyDepartCoursesResult>> GetMyDepartCoursesAsync(string query, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default)
        {
            ...
            var _ = await _context.SqlQueryAsync<GetMyDepartCoursesResult>("EXEC @returnValue = [dbo].[GetMyDepartCourses] @query = @query", sqlParameters, cancellationToken);
